    ...
    render() {
        ...
        return <div className="ui-g dashboard">
                    ...
                    <div className="ui-g-12 ui-md-6 ui-lg-3">
                        <div className="ui-g overview-box overview-box-1">
                    ...
                    <div className="ui-g-12 ui-md-6 ui-lg-3">
                        <div className="ui-g overview-box overview-box-2">
                            <div className="overview-box-title">
                    ...
                    <div className="ui-g-12 ui-md-6 ui-lg-3">
                        <div className="ui-g overview-box overview-box-3">
                            <div className="overview-box-title">
                    ...
                    <div className="ui-g-12 ui-md-6 ui-lg-3">
                        <div className="ui-g overview-box overview-box-4">
                            <div className="overview-box-title">
                    ...
                    <div className="ui-g-12 ui-lg-6 global-sales">
                    ...
                    <div className="ui-g-12 ui-lg-6 product-statistics">
                    ...
                    <div className="ui-g-12 ui-md-6 ui-lg-4 ui-fluid contact-form">
                        <Panel header="Contact Us" style={{minHeight: '415px'}}>
                            <div className="ui-g">
                                ...
                                <div className="ui-g-12">
                                    <Button type="button" label="Send" icon="fa-send"></Button>
                                </div>
                            </div>
                        </Panel>
                    </div>
                    ...
                    <div className="ui-g-12 ui-lg-4">
                        <div className="card timeline ui-fluid">
                            <div className="ui-g">
                                ...
                                <div className="ui-g-12">
                                    <Button type="button" label="Refresh" icon="fa-refresh" className="rounded-btn raised-btn"></Button>
                                </div>
                            </div>
                        </div>
                    </div>
