                    ...
                    <div className="card card-w-title">
                        ...
                        <div className="ui-g">
                            <div className="ui-g-12" style={{textAlign:'center'}}>
                                ...
                                <Button label="Secondary Button" style={{marginBottom:'10px'}} className="secondary-btn" />
                                <Button label="Inline Button" style={{marginBottom:'10px', width: 'auto'}} />
                                <Button label="Success Button" style={{marginBottom:'10px'}} className="success-btn" />
                                <Button label="Info Button" style={{marginBottom:'10px'}} className="info-btn" />
                                <Button label="Warning Button" style={{marginBottom:'10px'}} className="warning-btn" />
                                <Button label="Danger Button" style={{marginBottom:'10px'}} className="danger-btn" />
                            </div>
                        </div>
                    </div>
                </div>
